  ...
  return (
    <div className="p-6">
      <div className="flex justify-between items-center mb-6">
        <div>
          <h1 className="text-2xl font-semibold text-primary">Itineraries</h1>
          <p className="text-secondary mt-1">Manage client itineraries</p>
        </div>
        {canCreate && (
          <Button onClick={() => navigate('/itineraries/new')}>Create Itinerary</Button>
        )}
      </div>
