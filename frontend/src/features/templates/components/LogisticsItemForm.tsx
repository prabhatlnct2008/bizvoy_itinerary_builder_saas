...
import { TemplateDayActivityCreate, ItemType } from '../../../types';
...
interface LogisticsItemFormProps {
  onAddItem: (item: TemplateDayActivityCreate) => void;
  displayOrder: number;
}
...
const LogisticsItemForm: React.FC<LogisticsItemFormProps> = ({
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const newItem: TemplateDayActivityCreate = {
      activity_id: undefined, // No library activity
      item_type: itemType,
